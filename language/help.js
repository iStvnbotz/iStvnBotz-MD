...
exports.menu = (botname, pushname) => {
	return`Haii Dek ${pushname} 

	Hi I Am ${botname} I Was Created By Steven Lim,This Bot Is Not 100% Perfect So Please Report To Creator Bot To Fix !!`
}

// List
exports.list = (pushname) => {
	return`Hi ${pushname} Please Choose Features Below`
}
